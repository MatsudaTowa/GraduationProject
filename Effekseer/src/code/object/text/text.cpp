...
const int	My::CText::s_nHyde = 18;	// 文字高さ	
const UINT	My::CText::s_nWide = 0;	// 文字幅
const UINT	My::CText::s_nBold = 0;	// 文字太さ
const UINT	My::CText::s_nMip = 0;		// ミップレベル	
const bool	My::CText::s_bItalic = FALSE;	// 文字が斜体か
const DWORD	My::CText::s_nFont = SHIFTJIS_CHARSET;		// フォント
const DWORD	My::CText::s_nSize = OUT_DEFAULT_PRECIS;	// 文字サイズ(変更不可)
const DWORD	My::CText::s_nPitch = DEFAULT_PITCH;		// ピッチ
...
/// 終了処理
/// </summary>
void My::CText::Uninit()
{
}
/// <summary>
/// 更新
/// </summary>
void My::CText::Update()
{
}
/// <summary>
/// 描画
...
void My::CText::SetAll(int nH, UINT nW, UINT nBold, UINT nMip, bool bItalic, DWORD nFont, DWORD nSize, DWORD nPitch, Type type)
{
	m_nHyde = nH;		// 文字高さ
	m_nWide = nW;		// 文字幅
	m_nBold = nBold;	// 文字太さ
...
void My::CText::SetText(const char* text)
{
	m_aText = text;
}
/// <summary>
...
/// <returns>生成されたオブジェクトのポインタ</returns>
My::CText* My::CText::create(int nHyde, UINT nWide, UINT nBold, UINT nMip, bool bItalic)
{
	CText* pTex = new CText();	// オブジェクト生成
...
/// <returns>生成されたオブジェクトのポインタ</returns>
My::CText* My::CText::create(int nHyde, UINT nWide, UINT nBold, UINT nMip, bool bItalic, DWORD nFont, DWORD nSize, DWORD nPitch, Type type)
{
	CText* pTex = new CText();	// オブジェクト生成

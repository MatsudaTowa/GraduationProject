...
m_isWaitView(false)
{
	GetZoneManager()->GetHandZone()->CreateRange({ SCREEN_WIDTH * HALF, 650.0f,0.0f }, { 360.0f, CCardFrame::CARD_HEIGHT }, { COLOR_WHITE.r,COLOR_WHITE.g,COLOR_WHITE.b,0.5f }, true);

...
m_isWaitView(false)
{
	GetZoneManager()->GetHandZone()->CreateRange({ SCREEN_WIDTH * HALF, 650.0f,0.0f }, { 360.0f, CCardFrame::CARD_HEIGHT }, { COLOR_WHITE.r,COLOR_WHITE.g,COLOR_WHITE.b,0.75f }, true,CSelectionRange::HAND);
	GetZoneManager()->GetWaitZone()->CreateRange({ 1200.0f, 10.0f,0.0f }, { 100.0f, 1000.0f }, { COLOR_BLUE.r,COLOR_BLUE.g,COLOR_BLUE.b,0.5f }, false, CSelectionRange::OTHER);
...
void My::CPlayerDuelState::Duel(CActiveSceneCharacter* character)
{
	...
	if (character->GetEnergy() < CActiveSceneCharacter::MAX_ENERGY && character->GetStatus().life > 0)

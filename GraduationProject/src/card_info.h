...
//
//		virtual HttpResponse Get(const std::string& url, int timeoutMs = 10000) = 0;
//
//		virtual HttpResponse Post(const std::string& url, const std::string& body, const std::string& contentType, int timeoutMs = 10000) = 0;
//	};
//
//	/**
//	* @brief カードの情報クラス
